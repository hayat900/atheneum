...
public class myadapter extends FirestoreRecyclerAdapter<model,myadapter.myviewholder> {
    ...
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull model model) {
        ...
        holder.email.setText("Author: "+model.getAuthor());
        holder.price.setText("Qty: "+model.getQty());
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        dbroot.collection("books").document(model.getTimestamp()).delete();
                    }
                });
        ...
        holder.edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final DialogPlus dialogPlus=DialogPlus.newDialog(holder.img.getContext())
                        .setContentHolder(new ViewHolder(R.layout.dialogcontent)).setExpanded(true,1100
                        ).create();
                //dialogPlus.show();
                ...
                EditText qty=myview.findViewById(R.id.uqty);
                ...
                btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        dbroot.collection("books").document(model.getTimestamp()).update(umap).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
    ...
    static class myviewholder extends RecyclerView.ViewHolder{
        ...
        public myviewholder(@NonNull View itemView) {
            ...
            email=(TextView)itemView.findViewById(R.id.price);
            price=(TextView)itemView.findViewById(R.id.email);
